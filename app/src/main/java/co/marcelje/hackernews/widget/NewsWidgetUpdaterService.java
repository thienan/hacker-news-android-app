...
public class NewsWidgetUpdaterService extends IntentService {
    private static final String ACTION_WIDGET_UPDATE = "co.marcelje.hackernews.widget.action.WIDGET_UPDATE";
    ...
    private void handleActionWidgetUpdate() {
        ...
        appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetIds, co.marcelje.hackernews.R.id.lv_news_list);
    ...
    static void updateAppWidget(Context context,
                                ...
                                int appWidgetId,
                                String newsType) {
        RemoteViews views = new RemoteViews(context.getPackageName(), co.marcelje.hackernews.R.layout.widget_news_layout);
        views.setTextViewText(co.marcelje.hackernews.R.id.tv_title, newsType);
    ...
    private static void setItemList(Context context, RemoteViews views, int appWidgetId) {
        ...
        views.setRemoteAdapter(co.marcelje.hackernews.R.id.lv_news_list, widgetItemIntent);
        views.setEmptyView(co.marcelje.hackernews.R.id.lv_news_list, co.marcelje.hackernews.R.id.tv_empty);
    }
    ...
    private static void setItemClick(Context context, RemoteViews views, String newsType) {
        ...
        views.setPendingIntentTemplate(co.marcelje.hackernews.R.id.lv_news_list, itemPendingIntent);
    }
    ...
    private static void setWidgetClick(Context context, RemoteViews views, String newsType) {
        ...
        views.setOnClickPendingIntent(co.marcelje.hackernews.R.id.news_widget, openActivityPendingIntent);
    }
    ...
    private static void setRefreshClick(Context context, RemoteViews views) {
        ...
        views.setOnClickPendingIntent(co.marcelje.hackernews.R.id.ib_news_refresh, refreshWidgetPendingIntent);
    }
    ...
    private static void setConfigClick(Context context, RemoteViews views, int appWidgetId) {
        ...
        views.setOnClickPendingIntent(co.marcelje.hackernews.R.id.ib_news_config, configWidgetPendingIntent);
    }
}
