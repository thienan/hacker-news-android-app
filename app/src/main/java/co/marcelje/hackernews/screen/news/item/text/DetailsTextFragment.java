...
import co.marcelje.hackernews.databinding.FragmentDetailsTextBinding;
import co.marcelje.hackernews.fragment.ToolbarFragment;

public class DetailsTextFragment extends ToolbarFragment {

    private static final String ARG_TEXT = "co.marcelje.hackernews.screen.news.item.text.arg.TEXT";
